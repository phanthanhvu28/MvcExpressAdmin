  ...
  fu_popover.prototype.setStyles = function(){
    ...
    if(this.options.themeName === "default"){
      if($("#fu_popover_styles_default").length){
          ...
          str += '.fu_popover_header_' + this.options.themeName + '{margin: 0;color:#A9D0F5;padding: 8px 14px;font-size: 14px;text-align: center;background-color: #f7f7f7;border-bottom: 1px solid #ebebeb;border-radius: 5px 5px 0 0;}.fu_popover_content_' + this.options.themeName + '{padding: 9px 14px;}';
